...
const setupStore = (overrides: Record<string, unknown> = {}) => {
    useAppStore.setState({
        tabs: [{
            ...
            searchQuery: '',
            files: [
                { path: `${basePath}/file1.txt`, name: 'file1.txt', is_dir: false, size: 100, modified: 0, created: 0, file_type: 'txt', is_hidden: false, is_symlink: false, is_archive: false, permissions: '', size_formatted: '100 B', modified_formatted: '2024/01/01 12:00', created_formatted: '2024/01/01 12:00', icon_id: '' },
                { path: `${basePath}/file2.txt`, name: 'file2.txt', is_dir: false, size: 200, modified: 0, created: 0, file_type: 'txt', is_hidden: false, is_symlink: false, is_archive: false, permissions: '', size_formatted: '200 B', modified_formatted: '2024/01/01 12:00', created_formatted: '2024/01/01 12:00', icon_id: '' },
            ],
